...
- `src/HashPDF.WinForms/bin/Release/HashPDF.exe`
- `src/HashPDF.Updater/bin/Release/HashPDF.Updater.exe`
...
- installs `HashPDF`
- installs `HashPDF.Updater` for direct file updates after the first updater-capable install
